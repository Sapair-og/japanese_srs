  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-claude-bg px-4 select-none animate-fade-in relative overflow-hidden">
      ...
      <div className="claude-panel rounded-3xl p-8 sm:p-10 w-full max-w-md shadow-lg bg-claude-card relative z-10 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-4 pt-1">
              ...
              <button
                ...
                className="w-full py-2.5 border border-claude-border hover:border-claude-text-muted hover:bg-claude-sidebar/30 text-claude-text-heading font-semibold rounded-xl text-xs flex items-center justify-center gap-2 cursor-pointer transition-all shadow-xs"
              >
        ...
        {/* Auth Toggle Footer */}
        <div className="text-center border-t border-claude-border/50 pt-4 select-none">
          <button
            type="button"
            onClick={() => {
              setErrorMsg(null);
