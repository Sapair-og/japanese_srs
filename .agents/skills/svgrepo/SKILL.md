---
name: svgrepo
description: "Fetch vector assets from svgrepo.com directly based on UI requirements. Trigger whenever the user asks for an icon (e.g. 'add a gear icon')."
---
...
3. SVG Repo URLs follow a predictable pattern: `https://svgrepo.com<keyword>/` or searching `https://www.svgrepo.com/vectors/<keyword>/`.
